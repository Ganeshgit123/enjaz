...
<div class="col-md-6">
<div class="en_who">
 <h1 class="banner-text-head text-left"><?php echo $bandet->description ?></h1>
<p class="banner-text-para text-left"><?php echo $bandet->description1 ?></p>
</div> 
</div>
...
<div class="container">
    <div class="row no-gutters">
           <div class="col-md-6">
           <h1 class="head-t"><?php echo $title ?></h1>
           <div class="box career-top">
            <p></p>
<a href="" class="know-more-btn">Know More</a>
        </div>
</div>
<div class="col-md-6">
           <img src="assets/images/career-business.png" width="470px" height="450px">
</div>
</div>
</div>
</section>
...
<div class="row">
           <div class="col-md-5">
            <div class="row color-bo">
            <div class="col-md-3">
                <img src="assets/images/upload.svg" width="75px" height="85px">
            </div> 
            
           <div class="col-md-8">
            <h4>Upload Your CV</h4>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. The industry’s standard dummy. text ever since the 1500s</p>
        </div>
        </div>
</div>
...
<div class="container">
  ...
  <?php foreach($sec2 as $secval){?>
    <div class="panel">
      <div class="panel-heading">
        
      <h4 class="panel-title">
        <a href="#panelBodyOne<?php echo $secval['id']?>" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"> <?php echo $secval['acc_title']?>
        <br>
        <span class="zed"><img src="assets/images/loc.svg" width="15px" height="15px">&nbsp;&nbsp; <?php echo $secval['acc_location']?>
</span>    
    </a>
        </h4>
      </div>
      <div id="panelBodyOne<?php echo $secval['id']?>" class="panel-collapse collapse in">
      <div class="panel-body">
      <?php echo $secval['acc_desc']?>
                <button type="button" class="btn btn-primary2" data-toggle="modal" data-target="#exampleModal">
                <?php echo $secval['apply']?>
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">Submit Your application</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <section class="en_contact2">
...
<form action="<?php echo base_url(); ?>user/add_career" id="form1" method="POST" enctype="multipart/form-data" >
<div class="container">
<div class="row">
<div class="col-md-6">
...
<input type="text" class="form-control" id="phone"  name="expirence" required>
</div>
</div>
</div>
<!-- <div class="form-group">
...
<span class="file-custom form-control"></span>
...
<div class="row">
<div class="col-md-12">
<p class="text-center"><input type="submit" class="btn btn-default en_btnspc2"/></p>
</div>  
</div>  
</div>
        ...
        success: function (JSON) 
        {
          if (JSON.error != '')
          ...
          else
           {
            ...
            $('.save').prop('disabled', false);
            window.location.href="<?php echo base_url();?>user/career";   
           }
        }
      });
    });
