...
<?php echo form_open('admin/update_vacancy', $attributes, $hidden);?>
<div class="form-body">
...
<input class="form-control" placeholder="Vacancy Title" name="title" type="text" value="<?php echo $title ?>">
</div>
</div>
...
<textarea  class="form-control" placeholder="Vacancy Description"  name="description"><?php  echo $description?></textarea>
