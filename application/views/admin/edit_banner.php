...
<label for="confirm_password" class="control-label">Description Line 1</label>
...
<div class="col-md-6">
<div class="form-group">
<label for="confirm_password" class="control-label">Description Line 2</label>
 
<textarea  class="form-control" name="description1"><?php echo $desc1 ?></textarea>
</div>
</div>
</div>
...
<label for="confirm_password" class="control-label">Image</label>
 ...
 <div class="col-md-6">
        <div class='form-group'>
          ...
          <img   class="img-thumb" src="<?php echo base_url().'upload/images/'.$img;?>" style="height:200px !important;width:200px !important;" id="u_file"> <a href="<?php echo site_url()?>download?type=images&filename=<?php echo $img;?>">Download</a>
          <?php } else {?>
          <p>&nbsp;</p>
          <?php } ?>
        </div>
