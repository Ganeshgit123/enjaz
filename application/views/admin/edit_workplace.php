...
<div class='col-md-4'><h4>Edit Workplace Section</h4></div>
...
<?php echo form_open('admin/update_wrkplace', $attributes, $hidden);?>
<div class="form-body">
...
<textarea  class="form-control" name="description"><?php echo $wrkplace_desc ?></textarea>
</div>
</div>


      <input type="hidden" class="form-control-file" id="habout2_img" name="himg" value="<?php echo $wrkplace_img  ?>" >
...
<label for="confirm_password" class="control-label">Image</label>
 ...
 <div class="col-md-6">
        <div class='form-group'>
          <?php if($wrkplace_img!='' && $wrkplace_img!='no file') {?>
          <img   class="img-thumb" src="<?php echo base_url().'assets/images/'.$wrkplace_img;?>" style="height:200px !important;width:200px !important;" id="u_file"> <a href="<?php echo site_url()?>download?type=images&filename=<?php echo $wrkplace_img;?>">Download</a>
          <?php } else {?>
          <p>&nbsp;</p>
          <?php } ?>
        </div>
