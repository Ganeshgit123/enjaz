...
<div class='col-md-4'><h4>Edit Catering</h4></div>
...
<?php echo form_open('admin/update_catering', $attributes, $hidden);?>
<div class="form-body">
...
<div class="form-group">
<label for="confirm_password" class="control-label">Images</label>
 ...
 <div class="col-md-6">
        <div class='form-group'>
          ...
          <img   class="img-thumb" src="<?php echo base_url().'assets/images/'.$img;?>" style="height:200px !important;width:200px !important;" id="u_file"> 
          <?php } else {?>
          <p>&nbsp;</p>
          <?php } ?>
        </div>
