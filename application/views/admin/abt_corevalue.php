...
<label for="confirm_password" class="control-label">Core Value Description</label>

<textarea  class="form-control" id="tinymce" name="about2_desc"><?php echo $about2_desc ?></textarea>
...
<label for="confirm_password" class="control-label">Image</label>
 ...
 <input type="file" class="form-control-file" id="about2_img" name="about2_img" onchange="readURL2(this);" >
</div> 
</div>

 <div class="col-md-6">
        <div class='form-group'>
          <?php if($about2_img!='' && $about2_img!='no file') {?>
          <img   class="img-thumb" src="<?php echo base_url().'assets/images/'.$about2_img;?>" style="height:200px !important;width:200px !important;" id="u_file0"> <a href="<?php echo site_url()?>download?type=assets/images&filename=<?php echo $about2_img;?>">Download</a>
          <?php } else {?>
          <p>&nbsp;</p>
          <?php } ?>
        </div>
